...
public class OrderItemAsserts {
    ...
    public static void assertOrderItemUpdatableFieldsEquals(OrderItem expected, OrderItem actual) {
        assertThat(expected)
            ...
            .satisfies(e ->
                assertThat(e.getSubtotal()).as("check subtotal").usingComparator(bigDecimalCompareTo).isEqualTo(actual.getSubtotal())
            );
    }
    ...
    public static void assertOrderItemUpdatableRelationshipsEquals(OrderItem expected, OrderItem actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getMenuItem()).as("check menuItem").isEqualTo(actual.getMenuItem()))
